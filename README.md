...
1. Download the latest release from [Releases](https://github.com/rajatkapoor/svar/releases)
2. Move `Svar.app` to your Applications folder
3. Open Svar from Applications
4. Grant the required permissions when prompted:
   - **Microphone** - For voice recording
   - **Accessibility** - For global hotkey and text insertion
5. Download a transcription model (V2 for English, V3 for multilingual)
6. Configure your preferred hotkey
7. Start dictating!
